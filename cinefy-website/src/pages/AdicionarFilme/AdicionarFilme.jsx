...
const allCategories = [
    "Ficção", "Ação", "Drama", "Terror", "Fantasia", "Animação", "Aventura", "Comédia",
    "Romance", "Suspense", "Super-Herói", "Distopia", "Musical", "Esporte", "Infantil", "Crime"
];
...
const AdicionarFilme = () => {
    ...
    const buttonText = isAdmin ? 'Adicionar Filme Imediatamente' : 'Enviar Solicitação';
    ...
    const handleCategoryToggle = (category) => {
        setFormData(prev => {
            ...
            if (isSelected) {
                return { ...prev, categorias: prev.categorias.filter(c => c !== category) };
            }
    ...
    const sugestoesAtores = atoresDb
        ...
        .filter(actor => novoAtor && actor.nome.toLowerCase().includes(novoAtor.toLowerCase()));
                    ...
                    <form className="movie-form" onSubmit={handleSubmit}>
                        ...
                        {loadingData ? (
                            <div className="loading-message">
                                <Zap size={24} className="spin-icon" /> Carregando dados do servidor...
                            </div>
                        ) : (
                            <>
                                ...
                                <div className="form-grid">
                                    <div className="form-group input-card">
                                        <label htmlFor="tempo_duracao">Tempo de duração (min)</label>
                                        <input
                                            type="number"
                                            id="tempo_duracao"
                                            name="tempo_duracao"
                                ...
                                <div className="form-group full-width input-card">
                                    <label htmlFor="codigo_trailer" className="label-with-icon-add">
                                    ...
                                    <div className="form-group card-select">
                                        ...
                                        <div className="select-wrapper">
                                            <select
                                                ...
                                                required
                                            >
                                                <option value="" disabled>Selecione uma produtora</option>
                                                {produtorasDb.map(p => (
                                ...
                                <div className="form-group full-width actors-section">
                                    <h3 className="section-title">
                                        <Users size={16} /> Atores Selecionados ({formData.atores.length}/{ACTOR_LIMIT})
                                    </h3>

                                    {!actorLimitReached && (
                                        <div className="autocomplete-container">
                                            <div className="form-group card-select input-actor-search">
                                                <label htmlFor="buscaAtor">Buscar ou Adicionar Ator</label>
                                                <input
                                                    type="text"
                                                    id="buscaAtor"
                                                    value={novoAtor}
                                            ...
                                            {novoAtor.length > 0 && (
                                                <ul className="suggestions-list">
                                                    {sugestoesAtores.length > 0 ? (
                                                        ...
                                                        >
                                                            <Plus size={16} /> Criar Novo Ator: <b>{novoAtor}</b>
                                                        </li>
                                                    )}
                                                </ul>
                                            )}
