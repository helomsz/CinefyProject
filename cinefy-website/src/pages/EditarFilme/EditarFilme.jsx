...
//mapeia os gêneros do filme para o mesmo id do banco
const generoIdMap = {
...
// pega todas as categorias de filme
const allCategories = Object.keys(generoIdMap);


// dados iniciais do formulário, ficam vazios até serem preenchidos
...
const EditarFilme = () => {
    ...
    useEffect(() => {
        const buscarFilmeParaEdicao = async () => {
            ...
            try {
                // faz as requisições para pegar os dados do filme, diretores e produtoras
                ...
                // atualiza os dados do filme no formulário
                setFormData({
    ...
    const handleCategoryToggle = (cat) => {
        // muda a categoria, se já estiver selecionada, remove, se não, adiciona
        setFormData(prev => {
