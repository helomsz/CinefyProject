...
import '../AdicionarFilme/AdicionarFilme.css';
        ...
        const buscarFilmeParaEdicao = async () => {
            ...
            try {
                ...
                setFormData({
                    ...
                    tempo_duracao: dataFilme.tempo_duracao || '',
                    ano: dataFilme.ano || '',
                    url_poster: dataFilme.poster || '',
                    url_banner: dataFilme.background || '',
                    trailer: dataFilme.trailer || '',
                    categorias: dataFilme.generos_nomes?.split(" | ").map(g => g.trim()) || [],
                    diretor_id: dataFilme.diretor_id || '',
                    produtora_id: dataFilme.produtora_id || '',
                    atores: dataFilme.elenco_completo?.map(a => a.nome) || []
                });
