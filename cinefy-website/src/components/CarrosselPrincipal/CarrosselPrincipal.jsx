...
// mock de filmes para o carrossel
...
function CarrosselPrincipal() {
    // gerenciamento do estado do índice do filme ativo no carrossel
        ...
        <div className="carrosselPrincipalContainer">
            ...
            <div className="carrosselAreaCards">
                {mockFilmesCarrossel.map((filme, index) => {
                    ...
                    // calcula a diferença de posição entre o índice atual e o índice ativo
                    const diff = (index - indiceAtivo + mockFilmesCarrossel.length) % mockFilmesCarrossel.length;

                    // condicional para aplicar classes diferentes dependendo da posição do item no carrossel
                    ...
                    // retorna o CardCarrossel com a classe calculada
                    return (
                        <CardCarrossel
                            key={filme.id}
                            filme={filme}
